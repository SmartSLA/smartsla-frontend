<template>
    <v-card>
                ...
                <v-layout row wrap align-center>
                    ...
                    <v-flex xs8>
                        <v-layout>
                            ...
                            <v-flex xs6 v-if="contract.features && contract.features.nonBusinessHours">{{ $t("Non business hours") }} </v-flex>
                        </v-layout>
                    </v-flex>
                                ...
                                <v-layout v-if="nonBusinessHours">
                                    <v-flex xs3>
                                        <v-text-field
                                            ...
                                            mask="###"
                                            :rules="[() => isSetDaysOrHours(commitment.supported.nonBusinessHours) || $i18n.t('Required field')]"
                                        ></v-text-field>
                                    </v-flex>
                                    <v-flex xs1></v-flex>
                                    <v-flex xs3>
                                ...
                                <v-layout v-if="nonBusinessHours">
                                    <v-flex xs3>
                                        <v-text-field
                                            ...
                                            mask="###"
                                            :rules="[() => isSetDaysOrHours(commitment.bypassed.nonBusinessHours) || $i18n.t('Required field')]"
                                        ></v-text-field>
                                    </v-flex>
                                    <v-flex xs1></v-flex>
                                    <v-flex xs3>
                                ...
                                <v-layout v-if="nonBusinessHours">
                                    <v-flex xs3>
                                        <v-text-field
                                            ...
                                            mask="###"
                                            :rules="[() => isSetDaysOrHours(commitment.resolved.nonBusinessHours) || $i18n.t('Required field')]"
                                        ></v-text-field>
                                    </v-flex>
                                    <v-flex xs1></v-flex>
                                    <v-flex xs3>
        ...
        <v-card-actions>
            ...
            <v-btn color="light-blue" flat @click="submit">{{ !editing ? $t("Add commitment") : $t("Edit commitment") }}</v-btn>
        </v-card-actions>
    </v-card>
</template>
