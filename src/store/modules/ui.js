...
const types = {
  ...
  SET_DRAWER_PERMANENT: "SET_DRAWER_PERMANENT",
...
const actions = {
  ...
  setDrawerPermanent({ commit }) {
    commit(types.SET_DRAWER_PERMANENT);
  },
